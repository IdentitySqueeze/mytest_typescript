...
export class Utils {
    ...
    mytest_rd(x, y, z, nonZero = true) {
        try {
            ...
            let prec = rtn.toPrecision(z + Math.trunc(rtn).toString().length);
    ...
    //Return val type?
    mylib_significant_figures(x, figures) {
        try {
